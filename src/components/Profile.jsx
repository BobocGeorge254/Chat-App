...
const Profile = () => {
  ...
  const imagesListRef = ref(storage, `images/${profileId}`);
  const profilePicRef = ref(storage, `images/${profileId}/profilepic`);
  ...
  const handleProfilePictureUpload = (event) => {
    ...
    reader.onload = async () => {
      const storageRef = ref(storage, `images/${profileId}/profilepic/${file.name}`);
      try {
   ...
   const handlePhotoUpload = () => {
     ...
     const imageRef = ref(storage, `images/${profileId}/${imageUpload.name + v4()}`);
